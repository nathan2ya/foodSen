...
<ul class="lnb">
  ...
  <li><a href="trainingEvent.do"><img src="./images/sub/notice/sub_stitle_02On.gif" alt="연수·행사" /></a></li>
  <li><a href="businessReferenceList.do"><img src="./images/sub/notice/sub_stitle_03Off.gif" alt="업무자료실" /></a></li>
