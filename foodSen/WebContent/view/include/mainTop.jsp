  ...
  <div id="header">
    ...
    <c:choose>
      ...
      <ul>
        ...
        <li class="bn"> <a href="http://food.sen.go.kr/login.do"><img src="./images/header/common/btn_login.gif" alt="로그인" /></a></li>
      </ul>
      </c:when>
      ...
      <ul>
      	...
      	<span class="orange">${loginUser.member_name }${realName }</span>님 환영합니다.</li>
