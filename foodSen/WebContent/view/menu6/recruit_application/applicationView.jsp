...
<script type="text/javascript">
	...
	function goEdit(){
		...
		location.href='/foodSen/applicationEditFrom.do?seq='+seq+'&currentPage='+currentPage+'&searchingNow='+searchingNow;
	}
						...
						<tr>
							...
							<td colspan="5" class="tl">
								<c:if test="${resultClass.attach_name != null}">
									<a href="/foodSen/application_FileDownload.do?attach_name=${resultClass.attach_name}">
