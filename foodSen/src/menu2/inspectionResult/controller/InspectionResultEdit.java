...
/*
 * 작성자: 류재욱
 * 설  명: 위생.안전성검사결과 update 클래스
 * 용  도: 위생.안전성검사결과 게시글 수정을 위함.
*/
...
public class InspectionResultEdit {
	...
	//위생.안전성검사결과 update
	private InspectionResultDTO resultClass = new InspectionResultDTO(); //수정할 레코드 가져오기 DTO
	private InspectionResultDTO paramClass = new InspectionResultDTO(); //수정 진행 레코드
